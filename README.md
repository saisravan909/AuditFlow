...
<p align="center">
  <a href="#our-solution" class="btn" style="background-color: #159957; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px; font-weight: bold; display: inline-block;">Get Started with AuditFlow</a>
</p>
...
Please read our [Contributing Guide](https://github.com/saisravan909/AuditFlow/blob/main/CONTRIBUTING) to get started.
